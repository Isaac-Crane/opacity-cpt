 ...
 */
 ...
 jsPsych.plugins['survey-likert-PANAS_AC'] = (function() {

    var plugin = {};

    plugin.info = {
      name: 'survey-likert-PANAS_AC',
      description: '',
      parameters: {
        questions: {
    ...
    plugin.trial = function(display_element, trial) {
      ...
      html += ".jspsych-survey-likert-statement { display:block; font-size: 25px; padding-top: 40px; padding-bottom: 0px; margin-bottom:-50px; text-align:left;}"+
