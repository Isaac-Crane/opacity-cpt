 ...
 */
 ...
 jsPsych.plugins['survey-likert-PSS_AC'] = (function() {

    var plugin = {};

    plugin.info = {
      name: 'survey-likert-PSS_AC',
      description: '',
      parameters: {
        questions: {
    ...
    plugin.trial = function(display_element, trial) {
      ...
      html += ".jspsych-survey-likert-statement { display:block; font-size: 20px; padding-top: 40px; padding-bottom: 0px; margin-bottom:0px; text-align:center;}"+
